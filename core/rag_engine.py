...
def build_rag_chain(transcript:str, mode: str = "api"):

    vector_store = build_vector_store(transcript, mode=mode)
...
def load_rag_chain(mode: str = "api"):
    vector_store = load_vector_store(mode=mode)
